...
response_for (see Ardes::ResponseFor::ClassMethods) allows you to decorate the respond_to block of actions on subclassed controllers.  This works nicely with http://plugins.ardes.com/doc/resources_controller

As of version 0.2.0 and later, response_for's functionality can be summed up in one sentence:
...
Simply add the response_for gem to your Gemfile
